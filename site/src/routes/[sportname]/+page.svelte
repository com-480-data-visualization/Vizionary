    ...
    <div class="h-screen w-full flex flex-col">
      ...
      <div class="flex flex-col flex-1 w-full p-2 gap-4">
        ...
        <div class="flex flex-row flex-3 w-full gap-4">
          ...
          <div
            class="w-1/5 h-full bg-white border-2 border-gray-300 rounded-xl flex items-center justify-center shadow-sm p-3"
          >
            <BoxComponent title="">
              <Parameters
          ...
          <!-- Top middle section with tabs - 2/5 width -->
          <div
            class="w-2/5 h-full flex flex-col bg-white border-2 border-gray-300 rounded-xl shadow-sm p-3"
          >
          ...
          <div class="w-2/5 h-full flex flex-col gap-4">
            ...
            <div
              class="w-full h-1/2 bg-white border-2 border-gray-300 rounded-xl flex items-center justify-center shadow-sm p-3"
            >
        ...
        <div class="flex flex-row flex-2 w-full gap-4">
          <!-- Bottom left section -->
          <div
            class="w-1/3 h-full bg-white border-2 border-gray-300 rounded-xl flex items-center justify-center shadow-sm p-3"
          >
